...
const AddToPlanBtn = ({data}) => {
    ...
    return  <button onClick={()=>handleAddBtn()} className="flex flex-1 items-center justify-center gap-2 rounded-full bg-[#ccff00] px-6 py-4 text-sm font-black uppercase text-black transition hover:bg-white">
